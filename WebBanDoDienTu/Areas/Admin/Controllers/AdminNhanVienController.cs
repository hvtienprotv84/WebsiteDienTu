...
namespace WebBanDoDienTu.Areas.Admin.Controllers
{
    public class AdminNhanVienController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDNhanVien,TenNhanVien,SDT,Email,DiaChi,ChucVu")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDNhanVien,TenNhanVien,SDT,Email,DiaChi,ChucVu")] NhanVien nhanVien)
        {
            if (ModelState.IsValid)
            {
